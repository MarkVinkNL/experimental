...
const { injectBackButton } = require("./lib/injectBackButton");
...
// Inject back button into all index.html files except the root one when deploying to GitHub Pages
injectBackButton(paths, {
  repoRoot: REPO_ROOT,
